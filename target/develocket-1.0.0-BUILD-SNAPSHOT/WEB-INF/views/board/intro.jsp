...
<body class="faq">
	...
	<div align="center" style="margin-top: 30px; ">
		<img class="imag" alt="이미지" src="${contextPath}/resources/board/intro/intro.png">

	</div>
	<div style="width: 80%; padding-bottom: 20px;">
		<button style="float: right;" class="btns" onclick="location.href='${contextPath}/'">뒤로 가기</button>		
	</div>
</body>
</html>